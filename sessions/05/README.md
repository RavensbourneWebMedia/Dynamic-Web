...
- results section: add view map button
- map section: add view list button
- Integrate boilerplate (with GeoLocation) and then BUGS!
- console.log() everything


Learn more & do more with [GeoFire](https://github.com/firebase/geofire-js) for Firebase.
