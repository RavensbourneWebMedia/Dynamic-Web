...
SNAKE.Food = SNAKE.Food || (function() {
    ...
    */
    return function(config) {
        ...
        elmFood.style.left = -1000 + "px";
        elmFood.style.top = -1000 + "px";
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "JavaScript Snake<p></p>Press the 'Play Game' below and then use the <strong>arrow keys</strong> on your keyboard to play the game. " + fullScreenText + "<p></p>";
        ...
        * @method getBoardState
        * @param {Number} The state of the board.
        */  
        ...
        * @param {DOM Element or String} Sets the container element for the game.
        */ 
        ...
        */ 
        ...
        if (typeof config.fullScreen === "undefined") {
